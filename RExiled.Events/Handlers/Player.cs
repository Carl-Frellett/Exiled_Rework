...
namespace RExiled.Events.Handlers
{
    public static class Player
    {
        ...
        public static event CustomEventHandler<RExiled.Events.EventArgs.Player.EnteringPocketDimensionEventArgs> EnteringPocketDimension;

        public static void OnEnteringPocketDimension(RExiled.Events.EventArgs.Player.EnteringPocketDimensionEventArgs ev) => EnteringPocketDimension?.InvokeSafely(ev);
